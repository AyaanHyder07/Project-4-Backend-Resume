...
public class TemplateDefaultTheme {
    ...
    public String getMotionLevel() { return motionLevel; }
    public void setMotionLevel(String motionLevel) { this.motionLevel = motionLevel; }
}
