...
public class UserProfileService {
    ...
    public UserProfileResponse create(String userId,
        ...
        if (profilePhoto != null && !profilePhoto.isEmpty()) {
            ...
            String imageUrl = cloudinaryService.uploadImage(profilePhoto, "resume/profile/" + resume.getId());
    ...
    public UserProfileResponse update(String userId,
        ...
        if (profilePhoto != null && !profilePhoto.isEmpty()) {
            try {
                String imageUrl = cloudinaryService.uploadImage(profilePhoto, "resume/profile/" + resumeId);
                profile.setProfilePhotoUrl(imageUrl);
    ...
    public PublicUserProfileResponse getPublic(String resumeId) {
        UserProfile profile = repository.findByResumeId(resumeId).orElse(null);
    ...
    private void applyFields(UserProfile profile, CreateUserProfileRequest request) {
    ...
    private void applyUpdate(UserProfile profile, UpdateUserProfileRequest request) {
        ...
        if (request.getDateOfBirth() != null) profile.setDateOfBirth(LocalDate.parse(request.getDateOfBirth()));
        ...
        if (request.getAchievementsSummary() != null) profile.setAchievementsSummary(request.getAchievementsSummary());
    }
