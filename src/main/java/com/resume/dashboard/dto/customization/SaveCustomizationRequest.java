...
public class SaveCustomizationRequest {
    ...
    // ─── Gradient override ───────────────────────────────────────────
    // If set, replaces the base theme's background with a custom gradient
    private ThemeBackground.GradientConfig customGradient;

    // ─── Typography overrides ─────────────────────────────────────────
    // Must be a valid Google Fonts family name or system font
    ...
    private Double baseFontSize;         // rem value e.g. 1.0, 1.125, 1.25

    @Min(100) @Max(900)
    private Integer headingWeight;       // 100, 200, 300, 400, 500, 600, 700, 800, 900
    ...
    // CSS border-radius string e.g. "0px", "8px", "16px", "999px"
